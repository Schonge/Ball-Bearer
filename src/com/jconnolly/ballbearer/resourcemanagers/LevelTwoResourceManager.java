...
public class LevelTwoResourceManager {
	...
	private static final LevelTwoResourceManager LEVEL_TWO_MAN = new LevelTwoResourceManager();
	...
	public void loadGameResources() {
		...
		ball2TR = BitmapTextureAtlasTextureRegionFactory.createFromAsset(gameTextureAtlas, levelTwoAct, "blueBall.png");
		ball3TR = BitmapTextureAtlasTextureRegionFactory.createFromAsset(gameTextureAtlas, levelTwoAct, "orangeBall.png");
		...
		finishTR = BitmapTextureAtlasTextureRegionFactory.createFromAsset(gameTextureAtlas, levelTwoAct, "orangeGoal.png");
		finish2TR = BitmapTextureAtlasTextureRegionFactory.createFromAsset(gameTextureAtlas, levelTwoAct, "redGoal.png");
		finish3TR = BitmapTextureAtlasTextureRegionFactory.createFromAsset(gameTextureAtlas, levelTwoAct, "blueGoal.png");
	...
	public static void prepareManager(Engine eng, Camera cam, VertexBufferObjectManager vbom, LevelTwoActivity levelTwoAct) {
		getLvlTwoResMan().engine = eng;
		getLvlTwoResMan().camera = cam;
		getLvlTwoResMan().vbom = vbom;
		getLvlTwoResMan().levelTwoAct = levelTwoAct;
	}
	...
	public static LevelTwoResourceManager getLvlTwoResMan() {
		return LEVEL_TWO_MAN;
	}
